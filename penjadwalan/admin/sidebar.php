...
<div class="app-sidebar" >
            <div class="logo">
                <a href="index.html" class="logo-icon"><span class="logo-text">IPWIJA</span></a>
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <img src="../source/assets/images/avatars/avatar.png">
                        <span class="activity-indicator"></span>
                        <span class="user-info-text">Nama_user<br><span class="user-state-info">Admin</span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="file-manager.html"><i class="material-icons-two-tone">school</i>Classes</a>
                    </li>
                    <li>
                        <a href="calendar.html"><i class="material-icons-two-tone">co_present</i>Lectrurers</a>
                    </li>
                    <li>
                        <a href="todo.html"><i class="material-icons-two-tone">date_range</i>Scheduler</a>
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="material-icons-two-tone">brightness_4</i>Theme Modes<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                    ...
                    <li>
                        <a href="todo.html"><i class="material-icons-two-tone">account_circle</i>Account</a>
                    </li>
                    <li>
                        <a href="todo.html"><i class="material-icons-two-tone">power_off</i>Logout</a>
                    </li>
                    <li>
